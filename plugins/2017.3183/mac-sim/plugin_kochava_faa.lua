...
-- Create library
local lib = Library:new{ name='plugin.kochava.faa', publisherId='com.coronalabs', version = 4 }
...
local function showWarning(functionName)
    print( functionName .. "WARNING: The Kochava FAA plugin is only supported on Android, iOS and tvOS devices. Please build for device" );
end
...
function lib.logStandardEvent()
    showWarning("kochava.logStandardEvent()")
end
